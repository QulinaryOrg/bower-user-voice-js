window.UserVoice = {
    ...
    account: {
        ...
        "name": "Qulinary Inc.",
        "white_labeled": false,
        "subdomain_ssl_host": "qulinary.uservoice.com",
        "subdomain_site_host": "qulinary.uservoice.com",
        "subdomain_key": "qulinary",
        "subdomain_id": 235254,
        "client_key": "fH77euzzvSyy9YTvIaGw5g",
        "client_options": null,
...
"undefined" != typeof UserVoice && UserVoice.showLightbox || ! function(t, e, o) {
    ...
    function d() {
        if (Y) {
            var t = l();
            t.parentNode.removeChild(t), F ? e.head.appendChild(F) : a("user-scalable=1"), Y = !1
        }
    }
    ...
    function k(t, e) {
        return e && ("support" === e.mode ? e.post_suggestion_enabled = !1 : "feedback" === e.mode && (e.contact_enabled = !1), delete e.mode, e.default_mode !== o && (e.classic_default_mode = e.default_mode), w(e)), T({
            mode: t
        }, e || {})
    }
    ...
    S.sanitizeValue = function(t, e) {
            ...
            var e, o, i, s, n, r, a, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
                p = "",
                d = 0;
            for (t = S.uTF8Encode(t); d < t.length;) e = t.charCodeAt(d++), o = t.charCodeAt(d++), i = t.charCodeAt(d++), s = e >> 2, n = (3 & e) << 4 | o >> 4, r = (15 & o) << 2 | i >> 6, a = 63 & i, isNaN(o) ? r = a = 64 : isNaN(i) && (a = 64), p = p + l.charAt(s) + l.charAt(n) + l.charAt(r) + l.charAt(a);
            return p
        }, S.extend = function(t) {
            for (var e = Array.prototype.slice.call(arguments, 1), o = e.length, i = 0; o > i; i++)
    ...
    var U = function(t, o) {
            ...
            return i.default_config = {
                cookie_name: "uvts",
                domain: "https://by2.uservoice.com",
                channel: "external",
                enabled: !0,
                logging_enabled: !1
            }, i
    ...
    var F, I = function(t) {
        ...
        P = "    html.uvw-dialog-open object,    html.uvw-dialog-open iframe,    html.uvw-dialog-open embed {      visibility: hidden;    }    html.uvw-dialog-open iframe.uvw-dialog-iframe {      visibility: visible;    }    ",
        L = function() {
            function t(t) {
            ...
            return t.prototype.push = function(t) {
                ...
                var o = /([^\-]+)-([^\-]+)/.exec(e.trigger_position),
                    ...
                    p = [D, "/dcache", "/widget/feedback-tab.png?t=", encodeURIComponent(e.tab_label), "&c=", e.tab_inverted ? encodeURIComponent(e.trigger_background_color) : "ffffff", "&r=", encodeURIComponent(n), e.tab_inverted ? "&i=yes" : ""].join(""),
                    d = e.trigger_position.replace(/middle-/, "").replace(/(bottom|top)-(right|left)/, "horizontal");
                d = ["tab-", d, e.tab_inverted ? "-light" : "-dark", r].join(""), d = [D, UserVoice.manifest[d]].join(""), e.bgImage = d, e.imgSrc = p, e.tab_label = u(e.tab_label), a = M[a], l = M[l], (N.ie6 || N.ieQuirks) && (a += "position:absolute !important;", "top" === i ? a += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + (!this.offsetHeight && 0)) + 'px');" : "middle" === i ? a += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + ((((document.documentElement.clientHeight || document.body.clientHeight) + (!this.offsetHeight && 0)) / 2) >> 0)) + 'px');" : "bottom" === i && (a += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + (document.documentElement.clientHeight || document.body.clientHeight) - this.offsetHeight) + 'px');")), e.tabStyle = c(a, {
                    color: e.trigger_background_color,
                    bgImage: e.bgImage
                }), e.linkStyle = l, "top" === i ? this.edge = "top" : "bottom" === i ? this.edge = "bottom" : "left" === s ? this.edge = "left" : "right" === s && (this.edge = "right"), this.rotation = n, this.options = e
            }, t
        }(),
        W = function() {
            function i() {}
            return i.template = '      <div class="uv-popover-content">        <div class="uv-popover-iframe-container"></div>        <div class="uv-popover-loading"><div class="uv-popover-loading-text">' + I("Loading") + '&#8230;</div></div>        <!-- shadow for ie8 -->        <div class="uv-popover-content-shadow"></div>      </div>    ', i.prototype.show = function(t) {
                ...
                }), i && i.parentNode && (this.iframe.loaded || N.ie && N.version < 10 ? i.parentNode.removeChild(i) : A.one(this.iframe.el, "load", function() {
        ...
        B = function() {
            ...
            return o.prototype = T({}, W.prototype), o.prototype.render = function() {
                ...
                var e, o, i;
                N.mobile && p(), W.prototype.show.apply(this, arguments), N.match(/iPhone OS 7/) && (e = this, i = function() {
                    e.visible() && (o !== y().height ? (t.scrollBy(0), o = y().height, setTimeout(i, 80)) : setTimeout(i, 800))
                }, i())
            }, o.prototype.hide = function() {
                W.prototype.hide.apply(this, arguments), N.mobile && (d(), this.needsReload = !0)
        ...
        J = function() {
            function t(t) {
                ...
                this.options = T({}, e, t), this.options.trigger_position.match(/^(bottom|top)-(left|right)$/) || (this.options.trigger_position = e.trigger_position), this.widgets = [], N.touch || v(), f()
            }
            return t.icon_images = {
                ...
                if (N.ie8) {
                    ...
                    s += "?trigger_color=" + encodeURIComponent(this.options.trigger_color), s += "&trigger_background_color=" + encodeURIComponent(this.options.trigger_background_color), s += "&icon_version=4", i = "<img src='" + s + "'/>"
                }
                this.el.innerHTML = i, N.ie8 || (this.options.trigger_color && (A(this.el, "path", "uv-bubble-foreground").style.fill = this.options.trigger_color), this.options.trigger_background_color && (A(this.el, "path", "uv-bubble-background").style.fill = this.options.trigger_background_color)), A.on(this.el, "click", function() {
        ...
        Q = function() {
            ...
            return i.setUvts = function(t) {
                ...
                i.name = t, $.sendUserData()
            }, i.setSSO = function(t) {
                i.sso = t, $.sendUserData()
                ...
                if (N.mobile) return this.pendingAutoprompt = !1, void 0;
                if (this.session === !1 || this.systemTrigger && this.systemTrigger.el === o) return this.pendingAutoprompt = !0, void 0;
                ...
                return 0 !== e ? _(e) >= 60 && (0 === o || _(o) >= 21) : !1
                ...
                return 0 !== e ? _(e) >= 42 && (0 === o || _(o) >= 21) : 7 === t.active_days && (0 === o || _(o) >= 21)
                ...
                return N.mobile && (s.mobile = !0), "lightbox" === s.target || "classic_widget" === s.mode ? new K(s, e) : s.target === !1 || "self" === s.target && !e ? (s.position = s.position || "bottom-right", new B(s, e)) : (s.position && s.position.match(/^(automatic|top|bottom|left|right)$/) || (s.position = "automatic"), N.mobile ? new B(s, e) : new R(s, e))
                ...
                r.type = "application/javascript", r.async = !0, r.defer = !0, r.src = ("https:" === e.location.protocol ? "https://" : "http://") + UserVoice.account.subdomain_ssl_host + "/clients/widgets/omnibox/autoprompts/create.json?" + g(s), n.parentNode.insertBefore(r, n)
    ...
    UserVoice.globalOptions = {}, UserVoice.push = function(t) {
        ...
        Q.tracker.identify(t), t && (t.email && Q.setEmail(t.email), t.name && Q.setName(t.name))
